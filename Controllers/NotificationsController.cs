...
namespace MeteorStrike.Controllers
{
    ...
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Message,Created,NotificationTypeId,HasBeenViewed,ProjectId,TicketId,SenderId,RecipientId")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Message,Created,NotificationTypeId,HasBeenViewed,ProjectId,TicketId,SenderId,RecipientId")] Notification notification)
        {
