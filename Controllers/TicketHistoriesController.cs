...
namespace MeteorStrike.Controllers
{
    ...
    public class TicketHistoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PropertyName,Description,Created,OldValue,NewValue,BTUserId,TicketId")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PropertyName,Description,Created,OldValue,NewValue,BTUserId,TicketId")] TicketHistory ticketHistory)
        {
